        ...
        <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === "ios" ? "padding" : undefined}>
          <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
            <View style={styles.brandBlock}>
              ...
              <Text style={styles.brandSub}>REJOINS L'ÉQUIPE</Text>
            </View>

            <View style={styles.card}>
              <Text style={styles.kicker}>CRÉE TON ACCÈS</Text>
              <Text style={styles.title}>Inscription</Text>
              <Text style={styles.subtitle}>Crée ton compte pour rejoindre l'espace de ton équipe.</Text>
              ...
              <View style={styles.inputWrap}>
                <Ionicons name="shield-checkmark-outline" size={20} color={Theme.colors.goldLight} />
                <TextInput
              ...
              <TouchableOpacity activeOpacity={0.86} disabled={loading} onPress={handleRegister} style={[styles.button, loading && styles.buttonDisabled]}>
                {loading ? (
                  <ActivityIndicator color="#080808" />
                ) : (
                  <>
                    <Text style={styles.buttonText}>CRÉER LE COMPTE</Text>
                    <Ionicons name="person-add-outline" size={19} color="#080808" />
                  </>
                )}
              </TouchableOpacity>

              <TouchableOpacity onPress={() => router.back()} style={styles.linkButton}>
                <Text style={styles.linkMuted}>Déjà membre ? </Text>
...
const styles = StyleSheet.create({
  ...
  logo: { width: 78, height: 78, borderRadius: 22, marginBottom: 8 },
  brandName: { color: "#fff", fontSize: 30, fontWeight: "900", letterSpacing: 4 },
  brandSub: { color: "#D6D6D6", fontSize: 9, fontWeight: "800", letterSpacing: 2.6, marginTop: 2 },
  card: { backgroundColor: "rgba(8,8,8,0.8)", borderRadius: 28, borderWidth: 1, borderColor: "rgba(224,184,67,0.48)", padding: 22, shadowColor: Theme.colors.gold, shadowOpacity: 0.22, shadowRadius: 20, elevation: 10 },
  ...
  subtitle: { color: "#CFCFCF", marginTop: 8, marginBottom: 22, fontSize: 15, lineHeight: 22 },
  ...
  passwordHint: { color: "#BDBDBD", fontSize: 11, marginTop: -4, marginBottom: 10, marginLeft: 4 },
  button: { minHeight: 58, backgroundColor: Theme.colors.gold, borderRadius: 19, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 4 },
  buttonDisabled: { opacity: 0.65 },
  buttonText: { color: "#080808", fontWeight: "900", letterSpacing: 1.1 },
