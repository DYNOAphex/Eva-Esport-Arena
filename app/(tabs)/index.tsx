      ...
      <ImageBackground source={marbleSource} resizeMode="cover" style={styles.background} imageStyle={styles.backgroundImage}>
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={refreshApp} tintColor={Theme.colors.goldLight} colors={[Theme.colors.gold]} progressBackgroundColor="#151515" title={refreshText} titleColor={Theme.colors.goldLight} />}>
          ...
          <View style={styles.header}>
            <TouchableOpacity style={styles.roundButton} activeOpacity={0.8} onPress={() => router.push("/(tabs)/profile")} accessibilityLabel="Ouvrir les réglages des notifications"><Ionicons name="notifications-outline" size={23} color="#fff" />{pendingCount > 0 && <View style={styles.notificationDot} />}</TouchableOpacity>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#070707" }, background: { flex: 1 }, backgroundImage: { opacity: 0.42 }, backgroundShade: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(0,0,0,0.64)" }, vignetteTop: { position: "absolute", top: 0, left: 0, right: 0, height: 190, backgroundColor: "rgba(0,0,0,0.3)" }, content: { paddingHorizontal: 18, paddingTop: 28, paddingBottom: 190 }, refreshHint: { color: "rgba(246,215,106,0.82)", fontSize: 10, textAlign: "center", marginBottom: 1 }, header: { minHeight: 96, flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 15 }, roundButton: { width: 50, height: 50, borderRadius: 25, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(8,8,8,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.14)" }, notificationDot: { position: "absolute", right: 7, top: 7, width: 10, height: 10, borderRadius: 5, backgroundColor: Theme.colors.gold }, brand: { flexDirection: "row", alignItems: "center", gap: 8 }, logo: { width: 44, height: 44, borderRadius: 12 }, brandName: { color: "#fff", fontSize: 27, fontWeight: "900", letterSpacing: 2.7 }, brandSub: { color: "#D7D7D7", fontSize: 8, fontWeight: "800", letterSpacing: 2.1, marginTop: -1 }, coachBadge: { width: 58, height: 74, borderRadius: 19, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(8,8,8,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.14)" }, coachLetter: { color: "#fff", fontSize: 22, fontWeight: "900" }, coachRole: { color: "#D0D0D0", fontSize: 10, fontWeight: "700" },
  heroCard: { overflow: "hidden", borderRadius: 24, padding: 18, backgroundColor: "rgba(9,9,9,0.86)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.12)", shadowColor: "#000", shadowOpacity: 0.18, shadowRadius: 12, elevation: 6 }, whiteGlass: { position: "absolute", top: -50, right: -96, width: 270, height: 410, borderRadius: 135, backgroundColor: "rgba(255,255,255,0.08)", transform: [{ rotate: "13deg" }] }, goldHairline: { position: "absolute", top: 0, left: 34, right: 34, height: 1, backgroundColor: "rgba(255,218,104,0.55)" }, heroTop: { flexDirection: "row", alignItems: "center" }, dateBadge: { width: 64, height: 74, borderRadius: 17, backgroundColor: "#F5F1E8", alignItems: "center", justifyContent: "center", marginRight: 16 }, dateMonth: { color: "#725C1D", fontSize: 12, fontWeight: "900" }, dateDay: { color: "#111", fontSize: 30, lineHeight: 32, fontWeight: "900" }, eyebrow: { color: Theme.colors.goldLight, fontSize: 15, fontWeight: "900", letterSpacing: 1.1 }, confirmedSmall: { color: "#91D653", fontSize: 12, fontWeight: "900", marginTop: 6 }, versusRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginVertical: 28 }, teamName: { color: "#fff", fontSize: 27, fontWeight: "900", letterSpacing: 1, maxWidth: "42%" }, vs: { color: Theme.colors.gold, fontSize: 19, fontWeight: "900" }, metaRow: { flexDirection: "row", alignItems: "center", borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: "rgba(255,255,255,0.13)", paddingTop: 17 }, metaItem: { flex: 1, alignItems: "center" }, metaValue: { color: "#fff", fontSize: 14, fontWeight: "900", marginTop: 6 }, metaLabel: { color: "#D1D1D1", fontSize: 10, textAlign: "center", marginTop: 3 }, divider: { width: StyleSheet.hairlineWidth, height: 54, backgroundColor: "rgba(255,255,255,0.13)" }, confirmButton: { alignSelf: "center", minWidth: 190, height: 48, borderRadius: 24, marginTop: 19, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(4,4,4,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.14)" }, confirmText: { color: "#92DD54", fontSize: 17, fontWeight: "900" },
  statsGrid: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginTop: 14 }, statCard: { width: "48.4%", minHeight: 154, borderRadius: 24, padding: 15, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(8,8,8,0.86)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.1)", marginBottom: 12 }, statValue: { color: "#fff", fontSize: 32, fontWeight: "900", marginTop: 8 }, statLabel: { color: "#fff", fontSize: 14, fontWeight: "900", marginTop: 2 }, statDetail: { color: "#C8C8C8", fontSize: 11, marginTop: 6 }, sectionCard: { borderRadius: 24, padding: 16, backgroundColor: "rgba(8,8,8,0.88)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.1)", marginBottom: 14 }, sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }, onlineTitle: { flexDirection: "row", alignItems: "center" }, onlineDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: "#7AD351", marginRight: 8 }, sectionTitle: { color: Theme.colors.goldLight, fontSize: 12, fontWeight: "900", letterSpacing: 0.7 }, seeAll: { color: "#C8C8C8", fontSize: 12, fontWeight: "800" }, playersRow: { gap: 15, paddingRight: 8 }, player: { width: 65, alignItems: "center" }, avatar: { width: 59, height: 59, borderRadius: 30, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(18,18,18,0.94)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.14)" }, avatarInitial: { color: "#fff", fontSize: 22, fontWeight: "900" }, playerName: { color: "#fff", fontSize: 11, fontWeight: "900", marginTop: 7 }, playerStatus: { color: "#83D354", fontSize: 9, marginTop: 2 }, emptyRoster: { color: "#C8C8C8", textAlign: "center", paddingVertical: 16 }, announcement: { flexDirection: "row", alignItems: "center" }, announcementIcon: { width: 70, height: 70, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(212,175,55,0.08)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.1)", marginRight: 14 }, announcementContent: { flex: 1 }, announcementTitle: { color: "#fff", fontSize: 14, fontWeight: "900" }, announcementText: { color: "#D0D0D0", fontSize: 12, lineHeight: 18, marginTop: 5 }, announcementTime: { color: "#C8C8C8", fontSize: 10, marginTop: 5 },
});