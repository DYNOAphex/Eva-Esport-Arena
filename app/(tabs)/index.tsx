...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#070707" }, background: { flex: 1 }, backgroundImage: { opacity: 0.35 }, backgroundShade: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(0,0,0,0.7)" }, content: { paddingHorizontal: 18, paddingTop: 28, paddingBottom: 190 }, refreshHint: { color: "rgba(246,215,106,0.82)", fontSize: 10, textAlign: "center" },
  header: { minHeight: 96, flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 15 }, roundButton: { width: 50, height: 50, borderRadius: 25, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(8,8,8,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.14)" }, notificationDot: { position: "absolute", right: 7, top: 7, width: 10, height: 10, borderRadius: 5, backgroundColor: Theme.colors.gold }, headerSpacer: { width: 50 }, brand: { flexDirection: "row", alignItems: "center", gap: 8 }, logo: { width: 44, height: 44, borderRadius: 12 }, brandName: { color: "#fff", fontSize: 27, fontWeight: "900", letterSpacing: 2.7 }, brandSub: { color: "#D7D7D7", fontSize: 8, fontWeight: "800", letterSpacing: 2.1 },
  heroCard: { borderRadius: 24, padding: 18, backgroundColor: "rgba(9,9,9,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.12)" }, goldHairline: { position: "absolute", top: 0, left: 34, right: 34, height: 1, backgroundColor: "rgba(255,218,104,0.55)" }, heroTop: { flexDirection: "row", alignItems: "center" }, heroText: { flex: 1 }, dateBadge: { width: 64, height: 74, borderRadius: 17, backgroundColor: "#F5F1E8", alignItems: "center", justifyContent: "center", marginRight: 16 }, dateMonth: { color: "#725C1D", fontSize: 12, fontWeight: "900" }, dateDay: { color: "#111", fontSize: 30, fontWeight: "900" }, eyebrow: { color: Theme.colors.goldLight, fontSize: 15, fontWeight: "900" }, confirmedSmall: { color: "#91D653", fontSize: 12, fontWeight: "900", marginTop: 6 }, versusRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginVertical: 28 }, teamName: { color: "#fff", fontSize: 27, fontWeight: "900", maxWidth: "42%" }, vs: { color: Theme.colors.gold, fontSize: 19, fontWeight: "900" }, metaRow: { flexDirection: "row", borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: "rgba(255,255,255,0.13)", paddingTop: 17 }, metaItem: { flex: 1, alignItems: "center" }, metaValue: { color: "#fff", fontSize: 14, fontWeight: "900", marginTop: 6 }, metaLabel: { color: "#D1D1D1", fontSize: 10, textAlign: "center", marginTop: 3 }, confirmButton: { alignSelf: "center", minWidth: 190, height: 48, borderRadius: 24, marginTop: 19, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", backgroundColor: "#050505" }, confirmText: { color: "#92DD54", fontSize: 17, fontWeight: "900" },
  statsGrid: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginTop: 14 }, statCard: { width: "48.4%", minHeight: 154, borderRadius: 24, padding: 15, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(8,8,8,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.1)", marginBottom: 12 }, statValue: { color: "#fff", fontSize: 32, fontWeight: "900", marginTop: 8 }, statLabel: { color: "#fff", fontSize: 14, fontWeight: "900" }, statDetail: { color: "#C8C8C8", fontSize: 11, marginTop: 6 }, sectionCard: { borderRadius: 24, padding: 16, backgroundColor: "rgba(8,8,8,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.1)", marginBottom: 14 }, sectionHeader: { flexDirection: "row", justifyContent: "space-between", marginBottom: 16 }, sectionTitle: { color: Theme.colors.goldLight, fontSize: 12, fontWeight: "900" }, seeAll: { color: "#C8C8C8", fontSize: 12, fontWeight: "800" }, player: { width: 72, alignItems: "center", marginRight: 12 }, avatar: { width: 59, height: 59, borderRadius: 30, alignItems: "center", justifyContent: "center", backgroundColor: "#121212", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.14)" }, avatarInitial: { color: "#fff", fontSize: 22, fontWeight: "900" }, playerName: { color: "#fff", fontSize: 11, fontWeight: "900", marginTop: 7 }, emptyRoster: { color: "#C8C8C8", textAlign: "center", paddingVertical: 16 },
});
