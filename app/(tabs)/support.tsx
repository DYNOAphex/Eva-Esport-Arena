...
const styles = StyleSheet.create({
  ...
  whiteGlow: { position: "absolute", top: -70, right: -100, width: 320, height: 380, borderRadius: 190, backgroundColor: "rgba(255,255,255,0.02)" },
  content: { paddingHorizontal: 18, paddingTop: 24, paddingBottom: 130 },
  ...
  subtitle: { color: "#C6C6C6", marginTop: 7, fontSize: 12, lineHeight: 18 },
  onlinePill: { marginTop: 3, minHeight: 26, paddingHorizontal: 8, borderRadius: 999, flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "rgba(131,221,87,0.05)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(131,221,87,0.2)" },
  onlineDot: { width: 6, height: 6, borderRadius: 99, backgroundColor: "#83DD57" },
  onlineText: { color: "#98DA7D", fontSize: 7, fontWeight: "900" },
  quickInfoRow: { flexDirection: "row", gap: 7, marginTop: 16 },
  quickInfo: { flex: 1, minHeight: 48, borderRadius: 14, alignItems: "center", justifyContent: "center", gap: 4, backgroundColor: "rgba(255,255,255,0.035)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(246,215,106,0.12)" },
  quickInfoText: { color: "#BDBDBD", fontSize: 7, fontWeight: "800", textAlign: "center" },
  card: { marginTop: 14, padding: 16, borderRadius: 22, backgroundColor: "rgba(9,9,9,0.88)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(246,215,106,0.16)" },
  cardHeader: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 13 },
  icon: { width: 42, height: 42, borderRadius: 14, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(224,184,67,0.08)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(246,215,106,0.16)" },
  cardHeaderText: { flex: 1 },
  cardKicker: { color: Theme.colors.goldLight, fontSize: 8, fontWeight: "900", letterSpacing: 1.1 },
  cardTitle: { color: "#fff", fontSize: 18, fontWeight: "900", marginTop: 2 },
  input: { minHeight: 128, borderRadius: 16, paddingHorizontal: 14, paddingVertical: 13, color: "#fff", fontSize: 14, lineHeight: 20, backgroundColor: "rgba(255,255,255,0.04)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.13)" },
  inputFooter: { flexDirection: "row", alignItems: "flex-start", gap: 10, marginTop: 7 },
  cardText: { flex: 1, color: "#9E9E9E", fontSize: 9, lineHeight: 14 },
  counter: { color: "#777", fontSize: 9, fontWeight: "800" },
  button: { marginTop: 14, minHeight: 49, borderRadius: 15, flexDirection: "row", gap: 8, alignItems: "center", justifyContent: "center", backgroundColor: Theme.colors.goldLight },
  buttonDisabled: { opacity: 0.42 },
  buttonText: { color: "#080808", fontWeight: "900", fontSize: 10, letterSpacing: 0.8 },
  inboxSection: { marginTop: 24 },
  inboxHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 12 },
  inboxKicker: { color: Theme.colors.goldLight, fontSize: 8, fontWeight: "900", letterSpacing: 1.3 },
  inboxTitle: { color: "#fff", fontSize: 21, fontWeight: "900", marginTop: 3 },
  countBadge: { minWidth: 58, minHeight: 38, paddingHorizontal: 9, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(232,75,75,0.12)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(232,75,75,0.3)" },
  countBadgeEmpty: { backgroundColor: "rgba(131,221,87,0.05)", borderColor: "rgba(131,221,87,0.2)" },
  countText: { color: "#FF8585", fontSize: 15, fontWeight: "900" },
  countTextEmpty: { color: "#8FD773" },
  countLabel: { color: "#D57979", fontSize: 6, fontWeight: "900", marginTop: 1 },
  loadingBox: { minHeight: 80, borderRadius: 18, alignItems: "center", justifyContent: "center", gap: 7, backgroundColor: "rgba(9,9,9,0.82)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,255,255,0.1)" },
  emptyInbox: { padding: 22, borderRadius: 20, alignItems: "center", backgroundColor: "rgba(9,9,9,0.82)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(131,221,87,0.16)" },
  emptyIcon: { width: 44, height: 44, borderRadius: 15, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(131,221,87,0.06)" },
  emptyTitle: { color: "#fff", fontSize: 16, fontWeight: "900", marginTop: 9 },
  emptyText: { color: "#AFAFAF", textAlign: "center", marginTop: 5, fontSize: 10, lineHeight: 15 },
  reportCard: { padding: 15, borderRadius: 19, marginBottom: 10, backgroundColor: "rgba(9,9,9,0.9)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,214,91,0.22)" },
  reportResolved: { opacity: 0.66, borderColor: "rgba(131,221,87,0.2)" },
  reportTopRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  statusBadge: { minHeight: 25, paddingHorizontal: 8, borderRadius: 999, flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "rgba(232,75,75,0.09)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(232,75,75,0.2)" },
  statusResolved: { backgroundColor: "rgba(131,221,87,0.07)", borderColor: "rgba(131,221,87,0.2)" },
  statusDot: { width: 6, height: 6, borderRadius: 99, backgroundColor: "#FF7777" },
  statusDotResolved: { backgroundColor: "#83DD57" },
  statusText: { color: "#FF8585", fontSize: 7, fontWeight: "900", letterSpacing: 0.7 },
  statusTextResolved: { color: "#8FD773" },
  reportDate: { color: "#858585", fontSize: 8, fontWeight: "800" },
  playerRow: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 12 },
  playerAvatar: { width: 30, height: 30, borderRadius: 10, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(246,215,106,0.07)" },
  playerAvatarText: { color: Theme.colors.goldLight, fontSize: 9, fontWeight: "900" },
  reportPlayer: { color: "#FFFFFF", fontSize: 13, fontWeight: "900" },
  reportMessage: { color: "#EEEEEE", fontSize: 14, lineHeight: 20, fontWeight: "700", marginTop: 9 },
  diagnosticBox: { marginTop: 12, padding: 10, borderRadius: 13, backgroundColor: "rgba(255,255,255,0.035)" },
  diagnosticRow: { flexDirection: "row", alignItems: "center", gap: 6, marginVertical: 2 },
  diagnosticText: { flex: 1, color: "#AAAAAA", fontSize: 9, lineHeight: 14 },
  webDiagnostic: { color: "#858585", fontSize: 8, lineHeight: 13, marginTop: 5 },
  reportActions: { flexDirection: "row", gap: 8, marginTop: 12 },
  resolveButton: { flex: 1, minHeight: 42, borderRadius: 13, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,218,104,0.3)", backgroundColor: "rgba(246,215,106,0.035)" },
  resolveText: { color: Theme.colors.goldLight, fontSize: 8, fontWeight: "900" },
  deleteButton: { width: 42, minHeight: 42, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(130,20,20,0.09)", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(255,100,100,0.25)" },
});
